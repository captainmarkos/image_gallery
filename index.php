...
<meta name="description" content="Free Online Scuba Diver Photo Gallery" />
<meta name="keywords" content="dive log, free dive log, free online diver logbook, free diver logbook, photo gallery, image gallery" />
<title>Image Gallery</title>
<link rel="stylesheet" type="text/css" href="gallery.css" />
<?php if($page == 'list_image') { print "<script type=\"text/javascript\" src=\"javascript/jquery-1.5.1.min.js\"></script>\n"; } ?>
<?php if($page == 'list_image') { print "<script type=\"text/javascript\" src=\"javascript/jquery.tools.min.js\"></script>\n"; } ?>
<?php if($page == 'list_image') { print "<script type=\"text/javascript\" src=\"javascript/gallery.js\"></script>\n"; } ?>
</head>
<body>
...
?>
            ...
            <tr>
                <td align="left" class="igfont_small">Signed In: <?php print $_SESSION['email']; ?>&nbsp;</td>
...
<table width="750" border="0" align="center" cellpadding="2" cellspacing="1" class="table_main">
    <tr> 
        <th><a class="iglink2" href="index.php">Gallery</a> <?php echo showBreadcrumb(); ?></th>
    </tr>
    <tr>
        <td valign="top">
